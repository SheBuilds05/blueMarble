...
function LandingPage() {
  ...
  useEffect(() => {
    // 3-second delay to show the "secure connection" state
    const timer = setTimeout(() => {
      setIsInitializing(false);
      // Brief pause to show the logo before navigating to your login page
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center text-center z-10">
        ...
        {isInitializing ? (
          /* Initializing/Loading UI */
          <div className="flex flex-col items-center gap-4 animate-in fade-in zoom-in duration-700">
            <Loader2 className="w-10 h-10 text-blue-500 animate-spin" />
            <p className="text-[10px] font-bold tracking-[0.5em] uppercase text-blue-400/60">
              System Initializing
            </p>
          </div>
        ) : (
          /* blueMarble Branding - Visible briefly before redirect */
          <div className="animate-in fade-in zoom-in duration-1000">
            {/* The Concentric Circle Container */}
